<?php
/* Smarty version 3.1.29, created on 2016-03-01 09:44:43
  from "/home/yafstudy/1/application/views/Bang/index/publish.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56d5648b7b82f9_52330242',
  'file_dependency' => 
  array (
    '6980f91a048b83e6f61f163063e7cf9a45c634eb' => 
    array (
      0 => '/home/yafstudy/1/application/views/Bang/index/publish.tpl',
      1 => 1456825481,
      2 => 'file',
    ),
  ),
...
function content_56d5648b7b82f9_52330242 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
>
    <?php echo '<script'; ?>
 src="/public/common/js/jquery.cityselect.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
        ...
        <div class="ui-form-item ui-border-b ui-form-item-show">
            ...
            <div class="ui-select">
                <select id="task_category" name="category">
                    <?php
$_from = $_smarty_tpl->tpl_vars['task_categorys']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$__foreach_task_category_0_saved_item = isset($_smarty_tpl->tpl_vars['task_category']) ? $_smarty_tpl->tpl_vars['task_category'] : false;
$_smarty_tpl->tpl_vars['task_category'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['task_category']->_loop = false;
foreach ($_from as $_smarty_tpl->tpl_vars['task_category']->value) {
$_smarty_tpl->tpl_vars['task_category']->_loop = true;
$__foreach_task_category_0_saved_local_item = $_smarty_tpl->tpl_vars['task_category'];
?>
                    <option><?php echo $_smarty_tpl->tpl_vars['task_category']->value;?>
</option>
                    <?php
$_smarty_tpl->tpl_vars['task_category'] = $__foreach_task_category_0_saved_local_item;
}
if ($__foreach_task_category_0_saved_item) {
$_smarty_tpl->tpl_vars['task_category'] = $__foreach_task_category_0_saved_item;
}
?>
                </select>
            </div>

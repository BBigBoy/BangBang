...
class Db_Mysql extends PDO
{
     ...
     * @param null $sql
     * @param array $bind
     * @return bool|int|mixed|PDOStatement
     */
     ...
     *
     * @internal param string $table Database table to fetch from
     * @internal param array $where A field=>value array of where clause
     * @internal param string $fields Fields to include in result
     */
